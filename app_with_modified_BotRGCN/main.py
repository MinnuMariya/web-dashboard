...
from modified_BotRGCN.utils import accuracy,init_weights
import numpy as np
...
np.save('Data/mod_train_acc.npy', train_acc)
np.save('Data/mod_val_acc.npy', val_acc)
...
# Save the plot
plt.savefig('mod_training_val_loss.png')

# Save the data as numpy arrays
np.save('Data/mod_train_loss.npy', train_loss)
np.save('Data/mod_val_loss.npy', val_loss)

# Save the figure
plt.savefig('mod_confusion_matrix.png')
